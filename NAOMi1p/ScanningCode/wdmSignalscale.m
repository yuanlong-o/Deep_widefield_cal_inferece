...
Ftavg  = 4 * phi*eta*conc*epsilon* nidx* pavg * lambda / vol * vol_params.vres^2; % photons per micron^2
% the coefficients can be adjusted to match the realistic situations
